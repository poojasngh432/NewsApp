...
public class NewsByKeyword extends AppCompatActivity {
    private String keyword_str = "covid";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_by_keyword);
        mContext = NewsByKeyword.this;
    ...
    private void callApi() {
        ...
        Call<News> call = api.getNewsByKeyword(data);
    ...
    private void setRecyclerView() {
        if(newsdata != null){
            ...
            layoutManager = new LinearLayoutManager(NewsByKeyword.this);
    ...
    private void initListener(){
        ...
        newsAdapter.setOnItemClickListener(new NewsAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(NewsByKeyword.this, NewsDetailActivity.class);
